  ...
  <div class="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md">
      ...
      <div class="mt-4">
        ...
        >
          <div class="flex items-center pl-3 mx-2">
            <svg class="mx-auto h-5 w-5" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div v-if="userInfo" class="flex flex-col mt-8 w-full max-w-md">
      <div v-for="key in Object.keys(userInfo)" class="mt-1 flex flex-wrap break-all">
